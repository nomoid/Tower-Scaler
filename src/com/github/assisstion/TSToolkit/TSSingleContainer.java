...
public abstract class TSSingleContainer extends TSComponent implements
		TSContainer{
	...
	public TSSingleContainer(GUIContext container, int x1, int y1, int x2,
			int y2, TSComponent component){
	...
	public final void render(GameContainer container, Graphics g, int x, int y)
		...
		component
				.render(container, g, getContainerX() + x, getContainerY() + y);
	}
