...
public abstract class TSMultiContainer extends TSComponent implements TSContainer{
	...
	@Override
	public abstract void renderContainer(GameContainer container, Graphics g, int x, int y) throws SlickException;
}
